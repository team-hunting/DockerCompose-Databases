...
o.p="//static.hsappstatic.net/head-dlb/static-1.228/"
...
let n=!1
const o=()=>window.newrelic,i=e=>null===e?"Null":void 0===e?"Undefined":Object.prototype.toString.call(e).slice(8,-1),a=(e,t)=>{const n=r(4),a={tags:{isUnhandledPromiseRejection:!0}}
"string"==typeof e?n.captureMessage(e,a):n.captureException(e,a)
if(o()){const r={isUnhandledPromiseRejection:!0,typeOfReason:i(e)}
t&&(r.errorEvent=t)
o().noticeError(e,r)}},s=e=>"object"==typeof e?null!==e:"function"==typeof e,l=e=>{e.preventDefault()
if(s(e.promise)){console.error("Unhandled Promise Rejection",e.reason)
let t=""
try{"Not implemented on this platform"===e.reason&&(t=JSON.stringify(e))}catch(e){console.error("Error stringyfying PromiseRejectionEvent",e)}a(e.reason,t)}},u=()=>{n=!1
...
n.apply(e,[e].concat(o))}))},_parseDSN:function(e){var t=R.exec(e),r={},n=7
try{for(;n--;)r[j[n]]=t[n]||""}catch(t){throw new i("Invalid DSN: "+e)}if(r.pass&&!this._globalOptions.allowSecretKey)throw new i("Do not specify your secret key in the DSN. See: http://bit.ly/raven-secret-key")
...
Object.defineProperty(t,"__esModule",{value:!0})
t.default=void 0
const n=["api","local","app","private","platform","tools","meetings"],o=["hubspotstarter","hubspotfree"],i=["growth"],a={com:["hubspot","hubteam","grader","getsignals","getsidekick","gettally","hubspotemail","customer-hub","hubspotservicehub"].join("|"),net:o.join("|"),org:i.join("|")}
var s=function e(t){const r=new RegExp(`^(?!local|test|selenium)(.*\\.)?(${Object.entries(a).map(([e,t])=>`(?:${t})(qa)?\\.${e}`).join("|")}|(?:connect)\\.com|(?:connect)(qa)\\.co)$`).test(t.hostname),o=new RegExp(Object.entries(a).map(([e,t])=>`(?:${t})qa\\.${e}`).join("|")+"|(?:connect)\\.com|(?:connect)qa\\.co"),i=new RegExp(`^(?:${n.join("|")})-(.*).(?:hubspot|hubteam)(?:qa)?.com`),s="ENV",l="Enviro error: the default argument for .get and .getShort is no longer supported",u=e=>{let t=window[e]
...
return h(g(e))},v=b,m=e=>"prod"===v(e),_=e=>"qa"===v(e)
...
return"true"===(""+r).toLowerCase()},get:g,getHublet:()=>{const e=u("HUBLET")
return e||(i.test(t.hostname)?i.exec(t.hostname)[1]:"na1")},getInternal:b,getShort:v,isProd:m,isQa:_,normalize:p,set:function(e,t){if(1===arguments.length){t=e
...
try{t?localStorage.setItem("DEBUG",JSON.stringify(t)):localStorage.removeItem("DEBUG")}catch(e){f("DEBUG",t||void 0)}}}}}(document.location)
t.default=s
e.exports=t.default},function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
t.default=void 0
